# Jarvis 系统盲点审计 — 2026-05-23 15:08:26
...
| `gate_advice` | jarvis_conductor.py, jarvis_return_senti | ⚠️ 仅 to_swm_block default | ✅ default in prompt | 🟢 OK (prompt 通用) |
...
| `claim_stats.json` | 157 B | 5/5 | 🟢 健康 (size 极小) |
...
| `key_router_health.json` | 3435 B | 7/7 | 🟢 健康 |
