...
class JarvisWorkerThread(QThread):
    ...
    # 🆕 [Reshape M6.W3 / 2026-05-24 18:15] _TIER_*_KEYWORDS 4 lists 抽到
    # jarvis_worker_helpers.py. class attr 仍 expose (alias) 兼容 self._TIER_*_KEYWORDS
    # 老调用. 物理 list 定义在 helpers, 此处 import-time alias.
    _TIER_CRITICAL_KEYWORDS = TIER_CRITICAL_KEYWORDS
    _TIER_FACTUAL_RECALL_KEYWORDS = TIER_FACTUAL_RECALL_KEYWORDS
    _TIER_TOOL_KEYWORDS = TIER_TOOL_KEYWORDS
    _TIER_DEEP_KEYWORDS = TIER_DEEP_KEYWORDS
    ...
    # 🆕 [Reshape M6.W4 / 2026-05-24 18:30] _GENERIC_REFUSAL_PATTERNS / _STRONG_REFUSAL_PATTERNS
    # 抽到 jarvis_worker_helpers.py. class attr alias, 兼容 self._GENERIC_/_STRONG_REFUSAL_PATTERNS.
    # source of truth = memory_pool/refusal_vocab.json (CLI scripts/refusal_vocab_dump.py).
    _GENERIC_REFUSAL_PATTERNS = GENERIC_REFUSAL_PATTERNS
    _STRONG_REFUSAL_PATTERNS = STRONG_REFUSAL_PATTERNS
    ...
    # 🆕 [Reshape M6.W4 / 2026-05-24 18:30] _SLEEP_INTENT_PATTERNS / _SLEEP_TIME_EXTRACTORS /
