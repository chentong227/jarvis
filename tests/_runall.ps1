...
$tests = @(
    ...
    "_test_body_diff_p2_energy_grounded_sir_20260606",
    "_test_inner_anchor_affordance_sir_20260607",
    "_test_identity_facets_p0_step1_sir_20260607",
    "_test_sec9_c_correction_no_facet_touch_sir_20260607"
